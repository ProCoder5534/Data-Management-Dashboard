...
<body class="bg-gradient-to-tl from-blue-300 to-purple-500 h-screen">
    ...
    <nav>
      <ul class="relative h-32 w-screen">
        ...
        <li class="absolute right-[6cm] top-4">
          <button class="h-10 w-32 rounded-2xl bg-yellow-300 hover:rounded-full hover:border-4 border-blue-300 font-semibold">Credits</button>
        </li>
        <li class="absolute right-12 top-4">
          <button class="h-10 w-32 rounded-2xl bg-yellow-300 hover:rounded-full hover:border-4 border-blue-300 font-semibold">About</button>
        </li>
      </ul>
    </nav>
  </div>
  <div class="content mt-10 ml-[1.9cm]">
    ...
    <div class="scroll-container w-[30.8cm] overflow-x-auto mt-5">
      <div class="inside flex space-y-3">
        <div class="relative max-w-sm p-6 border bg-slate-900 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 transition-border hover:border-red-500">
          <!-- The icon image -->
          ...
          <div class="infoheading space-y-[1.7cm]">
            <a href="#">
              <h5 class="mb-4 text-4xl font-bold tracking-tight text-gray-300 dark:text-white mt-3">Employee List</h5>
            </a>
            <p class="mb-3 font-normal text-gray-400 dark:text-gray-400 text-xl">The Employee List of Abc Corporation (Confidential)</p>
          </div>
          <div class="button mt-[1.5cm]">
            <a href="#" class="inline-flex items-center px-4 py-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 text-xl">
              View Database
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col" bis_skin_checked="1">
    <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
      <svg xmlns="images/Locked.png" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-10 h-10 text-white p-2 bg-indigo-500 rounded-full" viewBox="0 0 24 24">
